...
@pytest.mark.parametrize("article_data, expected, expected_errors", [
    (
            [
                {
                    "art_id": "1",
    ...
    (
            ...
            [],
            [{'art_id': "Value 'leg' is not a valid integer"}, {'stock': "Value 'leg' is not a valid integer"}]
    ),
    (
            [
                {
...
@pytest.mark.parametrize("product_data, expected, expected_errors", [
    (
            [
                {
                    "contain_articles": ""
            ...
            [],
            [{"name": "This field is required"}, {"contain_articles": "This field is required"}]
    ),
    (
            [
                {
